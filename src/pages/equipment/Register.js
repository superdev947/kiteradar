  ...
  const register = () => {
    ...
    api
      ...
      .catch((error) => {
        ...
        Alert.alert(
          displayName,
          'Ocorreu um problema ao criar o equipamento tente mais tarde',
        );
      });
  };
      ...
      .then((results) => {
        ...
        axios
          ...
          .then((results) => {
            ...
            setLoading(false);
            Alert.alert(displayName, 'Equipamento cadastrado com sucesso');
            navigation.goBack();
          })
          .catch((error) => {
            setLoading(false);
